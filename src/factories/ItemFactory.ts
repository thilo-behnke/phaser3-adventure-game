...
import {ItemObject, ItemStats, ItemType, NUMBER_OF_ITEMS} from "../actors/ItemObject";
...
export class ItemFactory extends GameObjectFactory<ItemObject> {
    ...
    protected generateObject(seed: number): ItemObject {
        ...
        return new ItemObject(seed.toString(), itemTemplate.baseStats, itemTemplate.type);
    }
}
